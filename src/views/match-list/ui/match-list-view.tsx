  ...
  return (
    <>
      <TabScrollArea>
        ...
        {/*
          통산 적중률 — 이 기능이 주는 유일한 누적 지표이고, 다시 돌아올 이유의 대부분이다.
        ...
        */}
        {/*
          ...
          ⚠ 줄 전체가 링크다 — 적중률을 보다가 순위로 넘어가는 것이 자연스럽다. 다만 이 숫자는
            **통산**이고 랭킹은 시즌·라운드라, 시즌이 바뀌면 두 화면의 숫자가 원래 다르다.
        ...
        >
          {accuracy ? (
            <span className="min-w-0 truncate">
              {/* ⚠ "통산"을 라벨에 적는다 — 랭킹은 시즌·라운드 적중률이라 이게 없으면 두 숫자가
                  같은 것을 말하는 것처럼 읽힌다 */}
              통산 적중률{" "}
