 ...
 */
export function SignInView({ hasCode, canExchange, errorCode, errorDescription }: SignInViewProps) {
  ...
  return (
    ...
    >
      ...
      {errorMessage && (
        <p role="alert" className="mt-4 text-center text-[13px] leading-[1.5] text-crimson">
          {errorMessage}
        </p>
      )}

      <p className="mt-5 text-center text-[12px] leading-[1.7] text-ink-faint">
        처음 로그인하면 자동으로 가입돼요.
      </p>
    </AuthShell>
  );
